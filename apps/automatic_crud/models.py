...
class BaseModel(models.Model):
    ...
    create_template = 'crear.html'
    update_template = 'actualizar.html'
    list_template = 'listar.html'
    delete_template = 'confirm_delete.html'
    ...
    def build_generics_urls_crud(self) -> URLList:
        ...
        urlpatterns = [
            ...
            path(
                ...
                BaseCreate.as_view(
                    template_name=__model.create_template,
                    model=__model,
                    form_class=__create_form,
            ...
            path(
                ...
                BaseUpdate.as_view(
                    template_name=__model.update_template,
                    model=__model,
                    form_class=__update_form,
                    success_url=reverse_lazy("{0}".format(self.get_alias_list_url()))
                ),
